...
> 初始分析日期：2026-06-08
> 最后更新：2026-06-17（HelpView 重设计为 wiki 文档型布局）
...
2. **13 个后端 handler 未对接**
   - ~~统计~~ ✅、~~备份~~（创作端）、用户管理、角色、权限、邮件、系统设置、变量预设、预设订阅、文件条件、模板编辑器、模板分析、引擎、内置模板、分类
